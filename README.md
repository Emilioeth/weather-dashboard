  ...
  ![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Roboto+Condensed&size=30&pause=2000&color=0078D6&width=435&lines=Weather+Dashboard;By+Emili0)

  ![Project Img](/imgs/readmeIMG.png)
  
  ## Description
  Weather Dashboard is an app where you can check the weather for the next 5 days of any location.

  [Link](https://emilioeth.github.io/weather-dashboard/)

  ![visitors](https://visitor-badge.glitch.me/badge?page_id=Emilioeth.Weather+Dashboard&left_color=blue&right_color=blue)
  ...
  This app does not need installation, you can just go to the website through the link posted above and search for a city
